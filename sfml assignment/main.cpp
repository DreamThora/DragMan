...
int main()
{
    ...
    /////Rectangles
        ...
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::D))
        {
            ...
            if (rec1.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec2.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec3.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec4.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec5.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec6.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec7.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec8.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec9.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec10.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec11.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec12.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec13.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec14.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec15.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec16.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec17.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec18.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec19.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec20.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec21.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec22.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec23.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec24.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec25.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec26.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec27.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec28.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec29.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec30.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec31.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec32.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec33.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec34.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (rec35.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
            if (mobspawn.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(-shapeSprite.getGlobalBounds().width * 0.22f, 0.f);
        ...
        else if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
        {
                ...
                if (rec1.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec2.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec3.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec4.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec5.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec6.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec7.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec8.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec9.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec10.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec11.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec12.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec13.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec14.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec15.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec16.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec17.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec18.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec19.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec20.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec21.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec22.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec23.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec24.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec25.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec26.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec27.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec28.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec29.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec30.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec31.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec32.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec33.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec34.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (rec35.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
                if (mobspawn.getGlobalBounds().intersects(characcheckchon.getGlobalBounds())) shapeSprite.move(0.f, shapeSprite.getGlobalBounds().height * 0.22f);
        ...
        /*
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::W)) mon3.move(0.f, -time.asSeconds() * 100.f);
        else if (sf::Keyboard::isKeyPressed(sf::Keyboard::A))mon3.move(-time.asSeconds() * 100.f, 0.f);
        else if (sf::Keyboard::isKeyPressed(sf::Keyboard::S))mon3.move(0.f, time.asSeconds() * 100.f);
        else if (sf::Keyboard::isKeyPressed(sf::Keyboard::D))mon3.move(time.asSeconds() * 100.f, 0.f);
        */
        //mon2
        if (timemonrun >= 1.5 && timemonrun < 2)m2p = -1;
        ...
        //mon1
        if (timemonrun > 2.5 && timemonrun < 3)m1p = -2;
        ...
        printf("%f %f %d\n", mon3.getPosition().x, mon3.getPosition().y, m3p);
    }
    return 0;
}
